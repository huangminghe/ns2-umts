...
Agent/IFMNGMT/MIPV6 set shutdown_on_ack_ [lindex $argv 2]
...
$nd_bs2 router-lifetime 10

set nd_mn2 [$iface2 install-nd]

# install interface manager into multi-interface node and CN
set ifmgmt [$multiFaceNode install-ifmanager]
$ifmgmt attach-nd $nd_mn
$ifmgmt nd_mac $nd_mn [$iface1 set mac_(0)] ;#to know how to send RS
$ifmgmt attach-nd $nd_mn2
$ifmgmt nd_mac $nd_mn2 [$iface2 set mac_(0)] ;#to know how to send RS

set ifmgmt_cn [$router0 install-ifmanager]

# install MIH in multi-interface node
set mih [$multiFaceNode install-mih]

$ifmgmt connect-mih $mih ;#create connection between MIH and iface management

# add the handover module for the Interface Management
set handover [new Handover/5]
$ifmgmt handover $handover
...
$ifmgmt add-flow $nullvideo_($i) $udpvideo_($i) $iface2 1 
