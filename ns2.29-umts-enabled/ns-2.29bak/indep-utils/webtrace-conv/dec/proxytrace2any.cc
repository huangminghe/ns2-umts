...
enum InputFormatEnum { ifNone = 0, ifDECV1_0, ifDECV1_2 };
InputFormatEnum InputFormat = ifNone;
enum OutputFormatEnum { ofNone = 0, ofDECText, ofSquid, ofSquidSwapped } ;
OutputFormatEnum OutputFormat = ofNone;
