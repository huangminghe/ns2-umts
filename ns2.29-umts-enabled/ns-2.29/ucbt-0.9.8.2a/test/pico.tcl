...
$cbr2 set packetSize_ 1349
$cbr2 set interval_ 0.015


# make connections.
$ns at 0.01 "$node(0) make-bnep-connection $node(1) DH5 DH5 noqos "
$ns at 0.1 "$node(0) make-bnep-connection $node(2) DH3 DH1 noqos "
