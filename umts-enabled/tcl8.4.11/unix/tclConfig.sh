...
# installed.
TCL_PREFIX='/home/eric/ns/ns-allinone-2.29'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/eric/ns/ns-allinone-2.29'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/eric/ns/ns-allinone-2.29/tcl8.4.11/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/eric/ns/ns-allinone-2.29/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/eric/ns/ns-allinone-2.29/include'
...
# compiled.
TCL_SRC_DIR='/home/eric/ns/ns-allinone-2.29/tcl8.4.11'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/eric/ns/ns-allinone-2.29/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/eric/ns/ns-allinone-2.29/tcl8.4.11/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/eric/ns/ns-allinone-2.29/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/eric/ns/ns-allinone-2.29/tcl8.4.11/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/eric/ns/ns-allinone-2.29/lib/libtclstub8.4${TCL_DBGX}.a'
