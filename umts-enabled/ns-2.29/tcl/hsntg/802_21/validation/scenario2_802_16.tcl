...
Agent/MIHUser/IFMNGMT/MIPV6/Handover/SimpleAP set debug_ 1
...
Phy/WirelessPhy set freq_ 3.486e+9
Phy/WirelessPhy set RXThresh_ 2.51381e-10 ;#5.25089e-10
...
$bstationMac add-classifier [new SDUClassifier/Dest]
$bstationMac set-scheduler [new WimaxScheduler/BS]
...
set ifaceMac [$iface getMac 0]
$ifaceMac add-classifier [new SDUClassifier/Dest]
$ifaceMac set-scheduler [new WimaxScheduler/SS]
$ifaceMac set-channel 1
...
set handover_bs [new Agent/MIHUser/IFMNGMT/MIPV6/Handover/SimpleAP]
$bstation802 install-ifmanager $handover_bs
$nd_bs set-ifmanager $handover_bs 

$nd_bs set-router TRUE
$nd_bs router-lifetime 18
$ns at 1 "$nd_bs start-ra"
# add the handover module for the Interface Management
#$ifmgmt2 handover $handover

set mih_bs [$bstation802 install-mih]
$handover_bs connect-mih $mih_bs
set tmp_bs [$bstation802 set mac_(0)] 
$handover_bs nd_mac $nd_bs $tmp_bs
$tmp_bs mih $mih_bs
