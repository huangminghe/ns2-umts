...
#                                  \                             + iface0:802.11(3.0.1)|              |
#                                   \                            +---------------------+ MutiFaceNode |
#                                   rnc(0.0.0)                   + iface1:UMTS(0.0.2)  |  (4.0.0)     |
#                                      |                         +------------------------------------+
#                                 bstationUMTS(0.0.1)->)                  
#                                                                dummyNode:UMTS(0.0.3)
#              
...
AddrParams set nodes_num_   {4 1 1 2 1}	           ;# number of nodes for each cluster             
...
set bstation802 [$ns node 3.0.0] ;# node id is 7
...
$ns at 2.50001 "redirectTraffic"
$ns at 2.50001 "$ns trace-annotate \"Redirecting traffic\""
